...
- `group name` - a name of the group, required. A full list of group names is available [here](https://github.com/metanorma/bipm-editor-guides/blob/main/sources/bipm-references-en.adoc#appendix-a-bipm-groups-and-codes).
