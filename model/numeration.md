...
distinct from the physical size of the item as an object (e.g. height and breadth of a book,
...
> *Geology and mineral deposits of Lander County, Nevada*.
...
characteristic of contained items ([host item](/model/relations#host-item)),
...
typically involves volumes, pages, or timestamps, but can also extend to other
...
Mevlana Rumi]. *Ta Istorika* 10.18-19: 3-22. pp. 7-19".) However, the model
copes with this by separating the extent of a citation ([Citation Model](/model/citation))
from the extent of a bibliographic item, and the extent of a contained item
