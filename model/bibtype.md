...
> [!NOTE]
> The list of bibliographic types is a union of the types listed in ISO 690
...
`inbook`
: A typically untitled part of a book. May be a chapter (or section,
...
`collection`
: a grouping of multiple bibliographic resources (other than a website), which
themselves are presumed to be classified as belonging to bibliographic types.

Bibliographic types can overlap. A bibliographic item may be considered to
belonging to more than one bibliographic type.
