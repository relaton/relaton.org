...
preliminaryDraftOf::: document B is an immediate predecessor draft (unpublished
version) to document A, where the content of document B was modified to create
document A.
(_hasPreliminaryDraft_)

revisionDraftOf::: document B is an immediate successor draft (unpublished
version) to document A, where the content of document A was modified to create
document B. (_hasRevisionDraft_)
