...
draftOf:: document B is a draft (unpublished version) or revision of document A.
...
translation). Document A may or may not be published. (_hasDraft_)

predecessorDraftOf::: document B is an immediate predecessor draft (unpublished
version) to document A, where the content of document B was modified to create
document A.
(_hasPredecessorDraft_)

successorDraftOf::: document B is an immediate successor draft (unpublished
version) to document A, where the content of document A was modified to create
document B. (_hasSuccessorDraft_)

editionOf:: document B is a published revision of document A, or the first
...
have editions; editions cannot have editions). (_hasEdition_)
