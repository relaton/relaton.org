...
`collection`::
a grouping of multiple bibliographic resources (other than a website), which themselves
are presumed to be classified as belonging to a bibliographic type.
