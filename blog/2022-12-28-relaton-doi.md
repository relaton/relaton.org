...
authors:
  - "Nick Nicholas"
  - "Andrei Kislichenko"
description: "Relaton now supports auto-fetching Crossref bibliographic information via DOI identifiers."
---
...
Since 1997, the [Digital Object Identifier (DOI)](https://www.doi.org) service has
...
([ISO 26324:2012](https://www.iso.org/standard/43506.html),
[ISO 26324:2022](https://www.iso.org/standard/81599.html)), with the
...
[Crossref](https://www.crossref.org) is of particular interest in the data it
...
> [!NOTE]
> It is worth noting that out of the millions of DOI identifiers,
...
returns [on its landing page](https://search.crossref.org/?from_ui=yes&q=10.1515/9783110889406.257)
links not only to the
[Native Crossref JSON record](https://api.crossref.org/v1/works/10.1515/9783110889406.257)
and the
[URI of the associated resource](https://www.degruyter.com/document/doi/10.1515/9783110889406.257/html),
...
Relaton-DOI (the [relaton-doi](https://github.com/relaton/relaton-doi/) gem)
...
[Relaton CLI](https://github.com/relaton/relaton-cli/).
...
> [!NOTE]
> Page numbers are no longer essential for online access; but if a journal
