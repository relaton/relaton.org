...
authors:
  - "Ronald Tse"
  - "Andrei Kislichenko"
description: "Relaton now supports auto-fetching OpenLibrary bibliographic information via ISBN-10 and ISBN-13."
---
...
|---|---|
| ![ISO 2108:1972 cover](/blog/2024-01-19/iso-2108-1972-cover.png) | ![ISO 2108:2017 cover](/blog/2024-01-19/iso-2108-2017-cover.png) |

The standard was later revised as:

* [ISO 2108:1978](https://www.iso.org/standard/6897.html) (2nd edition);
* [ISO 2108:1992](https://www.iso.org/standard/6898.html) (3rd edition);
* [ISO 2108:2005](https://www.iso.org/standard/36563.html) (4th edition);
* [ISO 2108:2017](https://www.iso.org/standard/65483.html) (5th edition).
...
[International ISBN Agency](https://www.isbn-international.org). The agency is
...
> [!NOTE]
> These digits are the arabic numerals 0 to 9; in the case of the check
> digit only, an X can sometimes occur.

An ISBN (ISBN 10 code) consists of ten digits made up of the following parts:

group identifier
: The group number is assigned by the International ISBN Agency
...
[OpenLibrary](https://openlibrary.org) is a project of the
[Internet Archive](https://archive.org), aiming to create "one web page for every
book ever published."
...
> [!NOTE]
> Keep in mind that OpenLibrary is a community-driven project. While it
...
[Crossref](https://crossref.org) is a paywalled "for-profit service" run by a
...
[relaton-isbn](https://github.com/relaton/relaton-isbn) gem. This addition to
...
>
> | [Entry 1](https://openlibrary.org/books/OL18141225M/Snow_crash): Bantam trade reissue, May 2000 | [Entry 2](https://openlibrary.org/books/OL23230597M/Snow_crash): Bantam Spectra trade paperback reissue/September 2008 |
> |---|---|
> | ![Snow Crash entry 1](/blog/2024-01-19/snow-crash-1.png) | ![Snow Crash entry 2](/blog/2024-01-19/snow-crash-2.png) |
...
>
> This entry for
> [Beowulf and the Finnesburg Fragment](https://openlibrary.org/works/OL31707543W/Beowulf_and_the_Finnesburg_Fragment)
