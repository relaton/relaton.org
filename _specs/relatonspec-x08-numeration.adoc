---
title: Relaton specification -- Numeration and Pagination
...
contained item (link:relatonspec-x04-relations#host-item["host item"]),
...
copes with this by separating the extent of a citation (link:relatonspec-a02-citation[Citation Model])
