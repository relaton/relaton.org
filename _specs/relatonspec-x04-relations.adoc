...
supersedes::: document A supersedes document B, being applicable or valid in more or newer domains than document B (the two documents are not necessarily Expressions of the same Work) (_supersededBy_)
