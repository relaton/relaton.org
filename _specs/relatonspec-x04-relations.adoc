...
catalogues::: document A is a catalogue including a description of document B (_cataloguedBy_)
...
obsoletes::: document A supersedes document B, being applicable or valid in more or newer domains than document B (the two documents are not necessarily Expressions of the same Work) (_obsoletedBy_)
